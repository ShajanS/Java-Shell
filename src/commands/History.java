...
public class History implements Command {
  ...
  /**
   * Returns a list of the last n commands given to the filesystem, where n is
   * given by the user.
   * 
   ...
   * @return The index in the command list to start at in order to output as
   *         many commands as desired
   */
