...
/**
 * @author Kirill Lossev The class for the grep command, which searches files
 *         for lines matching a given regex.
 */
public class Grep implements Command {
   ...
   * @param params The optional -r flag, the regex to match, and the paths to
   *        search.
   */
  @Override
   ...
   */
  private String grepFiles(FileSystem fs, List<String> paths, Pattern pattern)
      throws InvalidArgumentException {
    String result = "";
    // For each path,
   ...
   * @return True iff there are enough tokens in the params for the command to
   *         be able to run
   */
