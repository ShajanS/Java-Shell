...
public class CommandHandler {
  ...
  // Handling the output. Returns anything that needs to be printed to the shell.
  public String handleOutput(data.FileSystem fs, String output){
    ...
    if (outputMode == STDOUT_MODE){
      ...
      // Otherwise, select the appropriate FileSystem method for the current mode
      ...
      if (!output.trim().isEmpty()){
       // Call the relevant method to put the output string into the given path.
