...
/**
 * @author Kirill Lossev Tests for the curl command
 */
public class CurlTest {
  ...
  /**
   * Setting up by defining the URLs to use, and a short sample of the text they
   * contain.
   */
  @Before
  public void setUp() {
  ...
  public void testHTMLFile() {
    ...
    try {
      ...
      String sample = fs.getFileContents(EXPECTED_HTML_NAME).substring(0,
          EXPECTED_HTML.length());
